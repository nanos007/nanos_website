      ...
      <SectionBand card>
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <FadeIn delay={0.1}>
            ...
            <form
              action="mailto:georgios.nanos@rwth-aachen.de"
              method="POST"
              encType="text/plain"
              className="space-y-4"
            >
              ...
              <button
                type="submit"
                className="w-full bg-primary text-on-primary text-sm font-medium py-2.5 rounded-lg hover:bg-primary-active transition-colors"
              >
                Submit
              </button>
            </form>
