    ...
    <section className="bg-canvas py-24 px-6 md:px-12">
      <div className="max-w-5xl mx-auto grid md:grid-cols-[1fr_200px] gap-12 items-center">
        <motion.div variants={containerVariants} initial="hidden" animate="visible">
          <motion.p variants={itemVariants} className="text-xs font-medium tracking-widest uppercase text-accent-steel mb-4">
          ...
          <motion.div variants={itemVariants} className="flex flex-wrap gap-3">
            ...
            <a href="https://de.linkedin.com/in/georgios-nanos-7048b25a" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-canvas text-ink text-sm font-medium px-5 py-2.5 rounded-lg border border-hairline hover:bg-surface-soft transition-colors">
